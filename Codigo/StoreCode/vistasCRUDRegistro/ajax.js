...
function mostrarBarrio(){
    ...
    divResultado = document.getElementById('listabarrio');
    calle=document.getElementById('obj_consejos').value;
 
    ajax=objetoAjax();
    ajax.open("POST", "barrio.php");
    ajax.onreadystatechange=function() {
        if (ajax.readyState==4) {
            divResultado.innerHTML = ajax.responseText
        }
