...
<div class="jumbotron text-center">
    <h1 class="display-2, logo">!Paso Final!</h1>
    <hr class="my-4"></hr>
    <p class="lead">Total a Pagar:
    <h4><i class="fas fa-dollar-sign"></i> <?php echo number_format($total,2);?></h4></p>     
    <td><form action="" method="post"><input type="hidden" name="id" value="<?php echo openssl_encrypt($rows['id'],COD,KEY); ?>"><button class="btn btn-primary" type="submit" name="btnAccion" value="Pagoenefectivo">Pago por PayPal</button></form></td>
