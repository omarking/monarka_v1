...
<!-- <nav class="navbar navbar-dark bg-dark text-white"> -->
    <nav class="navbar  text-white">
        <div class="container-fluid p-7">        
            ...
            <a href="../home/home.php"><img src="../img\utilidades\storetransblan.png" width="200" height="200" class="img-fluid"></a>
            </div>                
                        ...
                        <div class="col-12 col-md-7 alert alert-primary">
                            <div class="row">       
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="row">
                                        <div class="col-12 col-md-6">  
                                            <label for="inputCanP">Marca:  <span class="font-weight-bold"><?php echo  $rowMPC[8];?></span></label>                                    
                                        </div>
                                        <div class="col-12 col-md-6">  
                                            <label for="inputCanP">Categoría:  <span class="font-weight-bold"><?php echo  $rowMPC[9];?></span></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-12">                                        
                                    <div class="row">
                                        <div class="col-12 col-md-6">  
                                        <label for="inputCanP">Datos Vendedor: <br> <span class="font-weight-bold"><?php echo  $rowMPC[10];?></span></label>
                                        </div>
                                        <div class="col-12 col-md-6">  
                                        <label for="inputCanP"></span> email: <br> <span class="font-weight-bold"> <?php echo$rowMPC[11];?></span></label>
                                        </div>
                                    </div>
                                </div>
