...
$pdf->Cell(5,$textypos,"Argentina");
$pdf->setY(45);$pdf->setX(10);
$pdf->Cell(5,$textypos,"7751353439");
$pdf->setY(50);$pdf->setX(10);
$pdf->Cell(5,$textypos,"monarka@gmail.com");
...
$pdf->Cell(5,$textypos,"Nataly Cruz");
$pdf->setY(40);$pdf->setX(75);
$pdf->Cell(5,$textypos,"Santa Elena");
$pdf->setY(45);$pdf->setX(75);
$pdf->Cell(5,$textypos,"7751234567");
$pdf->setY(50);$pdf->setX(75);
$pdf->Cell(5,$textypos,"nataly@gmail.com");
