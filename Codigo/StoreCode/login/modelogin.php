...
if($loEmailU != '') {
        ...
        if($exisCA = 1){
                                ...
                                mysqli_close($conect);                                  
                                        ...
                                        if(@$extEmailU && @$extContraU){
                                            ...
                                            //HEADER LO USO PARA REDIRECCIONAMIENTO
            ...
            echo'<script type="text/javascript"> alert("Cuenta aún no activada, ¡¡¡Accede a tu Correo y activa tu cuenta!!!");window.location.href="../index.php";</script>';
        }
    ...
    echo "-------------------";
    echo'<script type="text/javascript"> alert("Campos vacíos, intente de nuevoXXX");window.location.href="../index.php";</script>';
}                                     
