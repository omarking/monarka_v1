...
@$reProvincia   = $_POST["obj_provincia"];
@$reCanton      = $_POST["obj_municipio"];
@$reParroquia   = $_POST["obj_consejos"];
@$reBarrio      = $_POST["obj_barrio"];
...
if($reCorreoU != '') { 
    ...
    if($reContraU == $reConfContraU){
        ...
        include("../model/conexion.php");         
        $consulta ="CALL psInsertUsuariov1('$reNombreU','$reApellido1U','$reCorreoU','$reContraU','$reConfContraU','$string','$reProvincia','$reCanton','$reParroquia','$reBarrio');";
        if(mysqli_query($conect,$consulta)){
            ...
            try {
                ...
                $mail->Username   = 'citlaliordunez@gmail.com';                     //SMTP username
                $mail->Password   = 'cit2210';                    //SMTP username
                ...
                //Recipients
                $mail->setFrom ('1718110401@gmail.com');
                $mail->addAddress($para);  
                    
                //Content
                $mail->isHTML(true);                                  //Set email format to HTML
                $mail->Subject = 'Link de activacion de Cuenta en Monarka'; //Asunto
                $mail->Body    = "<html lang ='es'>"
                                ...
                                . "</head>"
                                . "<body>"
                                . "Gracias por crear su cuenta en Monarka, para poder hacer uso de la tienda debe activar su  "
