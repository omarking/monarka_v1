...
<!-- <nav class="navbar navbar-dark bg-dark text-white"> -->
    <nav class="navbar  text-white">
        <div class="container-fluid p-7">
            <div class="col-sm-2">
                <a href="../home/home.php"><img src="../img\utilidades\storetransblan.png" width="200" height="200" class="img-fluid" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Home"></a>
            </div>
        ...
        <div class="card border-info" >
            ...
            <!--Inicio del formulario-->
                ...
                <!--onsubmit="return validarAltaProducto();"-->
                    ...
                    <?php
                        }elseif($orienCVcmb['contador'] == 0 ){                            
                            ?>
                               <a href="https://www.paypal.com/mx/home"><h5><i class="fab fa-cc-paypal fa-3x"></i> Crea tu Cuenta de PayPal, Para alojar Productos</h5></a> <br>
                               <a href="https://www.paypal.com/mx/home"><img src="../img/pasos/paso 1.PNG" alt="" width="200" > Paso 1.- Click en My Apps & Credentials</a><br> 
                               <a href="https://www.paypal.com/mx/home"><img src="../img/pasos/paso2.PNG" alt="" width="600" > Paso 2.- Click en My Apps & Credentials</a> <br>
                               <a href="https://www.paypal.com/mx/home"><img src="../img/pasos/paso3.PNG" alt="" width="200" > Paso 3.- Click en PayPal</a> <br>
                               <a href="https://www.paypal.com/mx/home"><img src="../img/pasos/paso4.PNG" alt="" width="600" > Paso 4.- Pega el Client ID</a> <br>
                            <?php                             
                        }
                        ?> 
            </div>
